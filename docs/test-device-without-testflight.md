...
Referências: [executar o app em dispositivos físicos](https://developer.apple.com/documentation/xcode/running-your-app-on-simulated-or-physical-devices), [ativar o Modo Desenvolvedor](https://developer.apple.com/documentation/xcode/enabling-developer-mode-on-a-device) e [visão geral de dispositivos registrados](https://developer.apple.com/help/account/devices/devices-overview).
