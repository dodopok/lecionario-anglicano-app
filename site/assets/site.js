(() => {
  ...
  const dictionaries = {
    pt: {
      ...
      privacy2Text: 'Para consultar o lecionário, o app se conecta à API por HTTPS e envia o X-App-Internal-Id, o LOC, a data e, quando disponíveis, o tipo de leitura e a versão da Bíblia. A API não armazena logs identificáveis dessas requisições.',
      ...
      privacy4Title: 'Registros operacionais',
      privacy4Text: 'New Relic e Sentry recebem registros operacionais não identificáveis para monitoramento e diagnóstico. Esses registros não são usados pelo serviço para identificar usuários.',
      privacy5Title: 'Responsável e solicitações',
      privacy5Text: 'O responsável pelo aplicativo é Douglas Araujo. Não há conta nem perfil remoto para excluir; as preferências ficam no aparelho e são removidas quando o app é desinstalado. Para dúvidas ou solicitações relacionadas à privacidade: dev@dodopok.dev.',
      privacy6Title: 'Dúvidas',
      privacy6Text: 'Para dúvidas sobre esta página, use o canal de suporte publicado neste site ou escreva para dev@dodopok.dev.',
    ...
    en: {
      ...
      privacy2Text: 'To consult the lectionary, the app connects to the API over HTTPS and sends the X-App-Internal-Id, prayer book, date, and, when available, the reading track and Bible version. The API does not store identifiable request logs.',
      ...
      privacy4Title: 'Operational records',
      privacy4Text: 'New Relic and Sentry receive non-identifiable operational records for monitoring and diagnostics. The service does not use these records to identify users.',
      privacy5Title: 'Responsible party and requests',
      privacy5Text: 'The app is operated by Douglas Araujo. There is no account or remote profile to delete; preferences stay on the device and are removed when the app is uninstalled. For privacy questions or requests: dev@dodopok.dev.',
      privacy6Title: 'Questions',
      privacy6Text: 'For questions about this page, use the support channel published on this site or email dev@dodopok.dev.',
    ...
    es: {
      ...
      privacy2Text: 'Para consultar el leccionario, la aplicación se conecta a la API mediante HTTPS y envía el X-App-Internal-Id, el LOC, la fecha y, cuando están disponibles, el tipo de lectura y la versión de la Biblia. La API no almacena registros identificables de estas solicitudes.',
      ...
      privacy4Title: 'Registros operativos',
      privacy4Text: 'New Relic y Sentry reciben registros operativos no identificables para monitorización y diagnóstico. El servicio no utiliza estos registros para identificar a los usuarios.',
      privacy5Title: 'Responsable y solicitudes',
      privacy5Text: 'El responsable de la aplicación es Douglas Araujo. No hay cuenta ni perfil remoto que eliminar; las preferencias permanecen en el dispositivo y se eliminan al desinstalar la aplicación. Para dudas o solicitudes de privacidad: dev@dodopok.dev.',
      privacy6Title: 'Dudas',
      privacy6Text: 'Para preguntas sobre esta página, utiliza el canal de soporte publicado en este sitio o escribe a dev@dodopok.dev.',
